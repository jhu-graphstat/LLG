...
In statistical decision theory, we say that a procedure $\delta^{\prime}$ dominates another procedure $\delta$ if and only if the risk of $\delta^{\prime}$ is no bigger than the risk of $\delta$ all the time, and strictly less than the risk of $\delta$ for in some situations. If there exists a decision procedure $\delta^{\prime}$ which dominates $\delta$, then $\delta$ is said to be inadmissible. So generally, inadmissible procedure is not preferred since there is another choice which is always ``better'' than it.
